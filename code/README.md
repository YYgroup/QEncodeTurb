...
- `geoencode_turb/turbulence_scales.py` evaluates the scale-inferred Reynolds and Taylor diagnostics.
...
- `geoencode_turb/curvature_analysis.py` contains the Gray-versus-binary conditional-angle analysis.
...
All output paths remain relative to this directory. The workflow creates the original `data/3D`, `data/conditional_angle_curvature`, and `figures` directories when needed.
